...
let arrLang = {
	  'en': {
	    ...
	    'skillsList': '<li><b>HTML</b> – HTML5, BEM, pure code;</li> <li><b>CSS</b> – CSS3 (flex-box, grids), SCSS, SASS;</li> <li><b>JavaScript</b> – EcmaScript 6, Jquery, JS libraries;</li> <li><b>Bootstrap 4</b>;</li> <li><b>WordPress</b> (creating own template);</li><li>Anatomy of <b>React JS</b> (how it works inside, creating own <b>State</b> and <b>Store</b>, work with API, using supporting libraries like <i>Redux, React-Redux, Redux-thunk, Redux-form, Axios</i> etc.);</li> <li>Work with <b>Git</b>;</li> <li><b>English level</b> allowing me to learn from the best on such sources as <i>w3schools, stackoverflow, MDN (Mozilla Developer Network)</i> and plenty of other sites for programmers;</li> <li>Ability to <b>quickly find</b> necessary information and master new technologies. </li>',
